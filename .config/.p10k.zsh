...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%173F\uE0B1'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=248
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=222
  # Custom icon.
